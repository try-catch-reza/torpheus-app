...
class DialogWebPadrao extends StatefulWidget {
  const DialogWebPadrao({
    super.key,
    required this.icon,
  ...
  @override
  State<DialogWebPadrao> createState() => _DialogWebPadraoState();
...
class _DialogWebPadraoState extends State<DialogWebPadrao> {
