...
import 'cadastrar_funcionario_web_header.dart';
import 'package:torpheus/core/constants/enum/funcao.dart';

class CadastrarFuncionarioWebBody extends StatefulWidget {
  const CadastrarFuncionarioWebBody({
    super.key,
    required this.state,
  ...
  @override
  State<CadastrarFuncionarioWebBody> createState() =>
      _CadastrarFuncionarioWebBodyState();
}

class _CadastrarFuncionarioWebBodyState extends State<CadastrarFuncionarioWebBody> {
    ...
    return Padding(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            const CadastrarFuncionarioWebHeader(),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CadastrarFuncionarioWebFooter(
                          ...
                          onCancelar: () {},
                          isLoading: widget.state is CadastrarFuncionarioLoading,
                        ),
                      ],
                    ),
                  ),
